...
public class RedDragon extends AbstractCreature {
	...
	public RedDragon(SplitScreenFpsEngine _game, ChaosGameModule _module, Vector3f startPos, WizardAvatar _side) {
		super(_game, _module, "Red Dragon", startPos, _side, false);
	}
